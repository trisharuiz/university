...
--
-- Dumping routines for database 'renovation'
--
/*!50003 DROP PROCEDURE IF EXISTS `printInvoice` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `printInvoice`(IN clientId int, INOUT invoice varchar(4000))
BEGIN
...
-- Dump completed on 2022-04-24  1:12:44
